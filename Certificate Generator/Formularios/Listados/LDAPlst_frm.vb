...
Public Class LDAPlst_frm
    ...
    End Sub
    ' INCICIO ======================= Procesos y funciones definidas por el usuario
    ...
    Private Sub Aplicar_Filtro(ByVal columna As String)
        ...
        If ret = 0 Then
            ...
            Filtro_txt.BackColor = Color.Red
        Else
            Filtro_txt.BackColor = Color.White
        End If
    ...
    ' FIN ======================= Procesos y funciones definidas por el usuario

    ' INICIO ======================= Procesos y funciones definidas por el sistema
    Private Sub Bw1_DoWork(sender As System.Object, e As System.ComponentModel.DoWorkEventArgs) Handles Bw1.DoWork
        ...
        Try
            ...
            Try
                ...
                tabla.Columns.Add("passwordLastSet").DataType = System.Type.GetType("System.Int32")
    ...
    Private Sub Bw1_RunWorkerCompleted(sender As System.Object, e As System.ComponentModel.RunWorkerCompletedEventArgs) Handles Bw1.RunWorkerCompleted
        ...
        pB1.Visible = False
        StatusLabel.Text = ""
        Export2excel.Visible = True
        GuardarComoExcelToolStripMenuItem.Visible = True

        InformaciónDetalladaToolStripMenuItem.Enabled = True
        InformaciónGeneralCompactaToolStripMenuItem.Enabled = True
        InformaciónDeProductosHOBToolStripMenuItem.Enabled = True

    End Sub

    Private Sub LDAPlst_frm_Load(sender As System.Object, e As System.EventArgs) Handles MyBase.Load
        Export2excel.Visible = False
        GuardarComoExcelToolStripMenuItem.Visible = False
        Label5.Visible = False
        'VerToolStripMenuItem.Visible = False

        InformaciónDetalladaToolStripMenuItem.Enabled = False
        InformaciónGeneralCompactaToolStripMenuItem.Enabled = False
        InformaciónDeProductosHOBToolStripMenuItem.Enabled = False
    ...
    Private Sub Export2excel_Click(sender As System.Object, e As System.EventArgs) Handles Export2excel.Click
        exportarExcel()
    End Sub
    ...
    Private Sub FiltradoBtn_Click(sender As System.Object, e As System.EventArgs) Handles FiltradoBtn.Click
        If DataGridView1.Rows.Count = 0 Then
            MsgBox("No hay resultados para mostrar, hága primero una búsqueda para poder filtrar los resultados")
        Else
            'Me.ActiveControl = Filtro_txt
            Me.Filtro_txt.Focus()
            Me.Filtro_txt.Select()
            If FiltradoPanel.Visible = False Then
                FiltradoPanel.Visible = True
            Else
                FiltradoPanel.Visible = False
            End If
        End If
    End Sub

    Private Sub Filtro_txt_TextChanged(sender As System.Object, e As System.EventArgs) Handles Filtro_txt.TextChanged
    ...
    Private Sub LDAPlst_frm_FormClosed(sender As System.Object, e As System.Windows.Forms.FormClosedEventArgs) Handles MyBase.FormClosed
    ...
    Private Sub GuardarComoExcelToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles GuardarComoExcelToolStripMenuItem.Click
        exportarExcel()
    End Sub

    Private Sub InformaciónDetalladaToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles InformaciónDetalladaToolStripMenuItem.Click
        InformaciónDetalladaToolStripMenuItem.Checked = True
        InformaciónGeneralCompactaToolStripMenuItem.Checked = False
        InformaciónDeProductosHOBToolStripMenuItem.Checked = False

        DataGridView1.Columns.Item("id").Visible = True
        DataGridView1.Columns.Item("cn").Visible = True
        DataGridView1.Columns.Item("sn").Visible = True
        DataGridView1.Columns.Item("GivenName").Visible = True
        DataGridView1.Columns.Item("passwordLastSet").Visible = True
        DataGridView1.Columns.Item("ExpCert").Visible = True
        DataGridView1.Columns.Item("CaducaCert").Visible = True
        DataGridView1.Columns.Item("jwt").Visible = True
        DataGridView1.Columns.Item("Jterm").Visible = True
        DataGridView1.Columns.Item("HOBftp").Visible = True
        DataGridView1.Columns.Item("DoD").Visible = True
        DataGridView1.Columns.Item("WSPUC").Visible = True
        DataGridView1.Columns.Item("UserSettings").Visible = True
        DataGridView1.Columns.Item("distinguishedName").Visible = True

    End Sub

    Private Sub InformaciónGeneralCompactaToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles InformaciónGeneralCompactaToolStripMenuItem.Click
        InformaciónDetalladaToolStripMenuItem.Checked = False
        InformaciónGeneralCompactaToolStripMenuItem.Checked = True
        InformaciónDeProductosHOBToolStripMenuItem.Checked = False
        ...
        DataGridView1.Columns.Item("GivenName").Visible = True
        DataGridView1.Columns.Item("passwordLastSet").Visible = True
        DataGridView1.Columns.Item("ExpCert").Visible = False
        DataGridView1.Columns.Item("CaducaCert").Visible = True
        DataGridView1.Columns.Item("jwt").Visible = False
        DataGridView1.Columns.Item("Jterm").Visible = False
        DataGridView1.Columns.Item("HOBftp").Visible = False
        DataGridView1.Columns.Item("DoD").Visible = False
        DataGridView1.Columns.Item("WSPUC").Visible = False
        DataGridView1.Columns.Item("UserSettings").Visible = False
        DataGridView1.Columns.Item("distinguishedName").Visible = True

    End Sub

    Private Sub InformaciónDeProductosHOBToolStripMenuItem_Click(sender As System.Object, e As System.EventArgs) Handles InformaciónDeProductosHOBToolStripMenuItem.Click
        InformaciónDetalladaToolStripMenuItem.Checked = False
        InformaciónGeneralCompactaToolStripMenuItem.Checked = False
        InformaciónDeProductosHOBToolStripMenuItem.Checked = True
        ...
        DataGridView1.Columns.Item("sn").Visible = True
        DataGridView1.Columns.Item("GivenName").Visible = True
        DataGridView1.Columns.Item("passwordLastSet").Visible = False
        DataGridView1.Columns.Item("ExpCert").Visible = False
        DataGridView1.Columns.Item("CaducaCert").Visible = False
        DataGridView1.Columns.Item("jwt").Visible = True
        DataGridView1.Columns.Item("Jterm").Visible = True
        DataGridView1.Columns.Item("HOBftp").Visible = True
        DataGridView1.Columns.Item("DoD").Visible = True
    ...
    Private Sub btnCancelar_ButtonClick(sender As System.Object, e As System.EventArgs) Handles btnCancelar.ButtonClick
        Bw1.CancelAsync()
    End Sub
End Class